...
If you have never used a terminal multiplexer, think of prefix mode as a short handoff: `ctrl+b` temporarily gives Herdr the next key, then control returns to the pane. You do not hold both keys together, and ordinary typing still goes to your shell or agent.
